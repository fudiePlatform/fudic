...
- [ ] **4. Extraer el build del Service Worker.**
...
- [ ] **5. Emitirlo como asset desde `generateBundle`.**
...
- [ ] **6. Reordenar build id y `BUILD_TOKEN`.**
...
- [ ] **7. URL literal en lugar de `ROLLUP_FILE_URL`.**
...
- [ ] Cobertura de ramas de `plugin.ts` **no inferior** a la de `main`.
- [ ] Anotar en el PR el tamaño de `dist/fudic-sw.js` antes y después (§7: crece, y es
      deliberado).
- [ ] Marcar BUG-03 como `Hecho` en [INDEX.md](./INDEX.md) (tabla + registro de progreso).
- [ ] Anotar en [SDD-20](../SDD-20-render-sw.md) §4.1 la regla «un realm con su propio
