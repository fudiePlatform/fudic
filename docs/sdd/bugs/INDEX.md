...
|---|---|---|---|---|
| [BUG-01](./BUG-01-shell-sin-politica.md) | El shell precacheado nunca se sirve desde caché | SDD-20 §4.6.1, §4.7 | `transport` · `vite` | `Listo` |
| [BUG-02](./BUG-02-html-por-ruta.md) | El router cachea HTML por ruta en lugar de renderizar | SDD-20 §4.2, §4.4, §4.6 | `transport` · `vite` | `Listo` |
| [BUG-03](./BUG-03-chunks-compartidos-sw.md) | Chunk servido desde caché y pedido a red a la vez | SDD-20 §4.1, §4.10 | `vite` | `Listo` |
