...
| [BUG-12](./BUG-12-sin-canal-de-update.md) | Un hijo que recibe un valor no tiene canal de actualización | SDD-15 §3.7, §4.7, §7 · props-spec 76 | `core` · `compiler` | `Listo` |
| [BUG-13](./BUG-13-comentario-razor-en-code.md) | Un comentario Razor dentro de `@code` borra todo el bloque | SDD-08 · SDD-11 | `compiler` | `Listo` |
| [BUG-14](./BUG-14-texto-literal-no-sobrevive.md) | El texto literal del autor no llega intacto al output | SDD-05 · SDD-15 §4.4 · gramática 1, 49 | `compiler` · `ssr` | `Listo` |
