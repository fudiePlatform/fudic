...
| [BUG-11](./BUG-11-sin-canal-de-update.md) | Un hijo que recibe un valor no tiene canal de actualización | SDD-15 §3.7, §7 · props-spec 76 | `core` · `compiler` | `Listo` |
