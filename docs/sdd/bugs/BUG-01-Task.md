...
- [x] **1. Test del shell servido desde caché.**
...
- [x] **2. Test del shell sin clases de recurso.**
      Mismo fichero, `resources: []` → sigue sirviéndose. **Verlo fallar** (§6.2).
- [x] **3. Test de auditoría de cableado.**
...
- [x] **7. Identidad antes que clase en `handleResource`.**
...
- [x] **8. Verde en 1, 2, 3 y los criterios 4 y 6.**
...
- [x] **9. Cablear la caché y la lista.**
...
- [x] **11. Validar el shell contra el bundle.**
...
- [x] **12. Arranque sin red en Chrome real.**
...
- [x] Cobertura de ramas de `router.ts` y `bootstrap.ts` **no inferior** a la de `main`.
- [x] Marcar BUG-01 como `Hecho` en [INDEX.md](./INDEX.md) (tabla + registro de progreso).
- [x] Anotar en [SDD-20](../SDD-20-render-sw.md) §4.7 que el shell tiene política, con
      enlace a este BUG.
