...
export const css = `:host{display:inline-block;}.badge{font-size:0.75rem;padding:0.15rem 0.5rem;border:1px solid #ccc;border-radius:999px;background:#f3f3f3;color:#444;}.badge.success{background:#e6f4ea;border-color:#34a853;color:#1e7e34;}.badge.warning{background:#fef7e0;border-color:#f9ab00;color:#b06000;}`;
